...
module PigglyParser
  ...
  def _nt_stmtForEachLoop
    ...
    if s1.last
      r1 = instantiate_node(Piggly::Parser::Nodes::ForEachLoop,input, i1...index, s1)
      r1.extend(StmtForEachLoop1)
    else
      @index = i1
      r1 = nil
    end
    if r1
      ...
      if s30.last
        r30 = instantiate_node(Piggly::Parser::Nodes::ForEachLoop,input, i30...index, s30)
        r30.extend(StmtForEachLoop2)
      else
        @index = i30
        r30 = nil
      end
    ...
    node_cache[:stmtForEachLoop][start_index] = r0
  ...
  def _nt_stmtForLoop
                                ...
                                if r20
                                  ...
                                  if r21
                                    ...
                                    if r22
                                      ...
                                      if s24.last
                                        r24 = instantiate_node(Piggly::Parser::Nodes::TLabel,input, i24...index, s24)
                                        r24.extend(StmtForLoop0)
                                      else
                                        @index = i24
                                        r24 = nil
                                      end
    ...
    if r1
      ...
      if s31.last
        r31 = instantiate_node(Piggly::Parser::Nodes::ForLoop,input, i31...index, s31)
        r31.extend(StmtForLoop2)
      else
        @index = i31
        r31 = nil
      end
  ...
  def _nt_stmtReturn
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::Return,input, i0...index, s0)
  ...
  def _nt_stmtRaise
    ...
    if s1.last
      r1 = instantiate_node(Piggly::Parser::Nodes::Raise,input, i1...index, s1)
    ...
    if r1
      ...
      if r16
        ...
        if r18
          ...
          s17 << r19
          if r19
            r25 = _nt_expressionUntilSemiColon
            s17 << r25
          end
        end
        if s17.last
          r17 = instantiate_node(SyntaxNode,input, i17...index, s17)
          r17.extend(StmtRaise3)
        else
          @index = i17
          r17 = nil
        end
      ...
      if s15.last
        r15 = instantiate_node(Piggly::Parser::Nodes::Throw,input, i15...index, s15)
        r15.extend(StmtRaise4)
      else
        @index = i15
        r15 = nil
      end
  ...
  module VarDeclarationMisc3
    def rval
      elements[3]
    end
  end

  module VarDeclarationMisc4
    def name
      elements[0]
    end
  ...
  def _nt_varDeclarationMisc
          ...
          if r7
            ...
            if r8
              ...
              if s14.last
                ...
                r14.extend(VarDeclarationMisc2)
              else
                @index = i14
                r14 = nil
              end
              ...
              if r13
                ...
                if r21
                  ...
                  if r23
                    ...
                    s20 << r26
                    if r26
                      r28 = _nt_expressionUntilSemiColon
                      s20 << r28
                    end
                  end
                end
                if s20.last
                  r20 = instantiate_node(SyntaxNode,input, i20...index, s20)
                  r20.extend(VarDeclarationMisc3)
                else
                  @index = i20
                  r20 = nil
                end
    ...
    if s0.last
      r0 = instantiate_node(SyntaxNode,input, i0...index, s0)
      r0.extend(VarDeclarationMisc4)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:varDeclarationMisc][start_index] = r0

    r0
  end

  module VarDeclarationCursor0
    def kwNO
      elements[0]
    end
  ...
  def _nt_varDeclarationCursor
    ...
    if r1
      ...
      if r2
        ...
        if s6.last
          ...
          r6.extend(VarDeclarationCursor0)
        else
          @index = i6
          r6 = nil
        end
        ...
        if s4.last
          r4 = instantiate_node(SyntaxNode,input, i4...index, s4)
          r4.extend(VarDeclarationCursor1)
        else
          @index = i4
          r4 = nil
        end
    ...
    if s0.last
      r0 = instantiate_node(SyntaxNode,input, i0...index, s0)
      r0.extend(VarDeclarationCursor2)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:varDeclarationCursor][start_index] = r0
  ...
  def _nt_dollarQuoteMarker
    ...
    if r1
      i3, s3 = index, []
      if has_terminal?(@regexps[gr = '\A[a-zа-яё_]'] ||= Regexp.new(gr), :regexp, index)
        r4 = true
        @index += 1
      else
        terminal_parse_failure('[a-zа-яё_]')
        r4 = nil
      end
      s3 << r4
      if r4
        s5, i5 = [], index
        loop do
          if has_terminal?(@regexps[gr = '\A[a-zа-яё_0-9]'] ||= Regexp.new(gr), :regexp, index)
            r6 = true
            @index += 1
          else
            terminal_parse_failure('[a-zа-яё_0-9]')
            r6 = nil
          end
          if r6
            s5 << r6
  ...
  def _nt_lValue
    ...
    if r1
      ...
      loop do
        ...
        s3 << r4
        if r4
          r5 = _nt_expressionUntilClosingBracket
          s3 << r5
          if r5
            if (match_len = has_terminal?(']', false, index))
              r6 = true
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::Assignable,input, i0...index, s0)
      r0.extend(LValue2)
    else
      @index = i0
      r0 = nil
  ...
  def _nt_kwARRAY
    ...
    node_cache[:kwARRAY][start_index] = r0
  ...
  def _nt_kwCOLLATE
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::TKeyword,input, i0...index, s0)
      r0.extend(KwCOLLATE0)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:kwCOLLATE][start_index] = r0
  ...
  def _nt_kwFOREACH
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::TKeyword,input, i0...index, s0)
      r0.extend(KwFOREACH0)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:kwFOREACH][start_index] = r0
  ...
  def _nt_kwNO
    ...
    node_cache[:kwNO][start_index] = r0
  ...
  def _nt_kwSTACKED
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::TKeyword,input, i0...index, s0)
      r0.extend(KwSTACKED0)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:kwSTACKED][start_index] = r0
